      ...
      <div className=" subtitle-1 flex w-full justify-center">
        <article className="h-[100%] max-h-full w-[90%] flex-col items-center justify-start rounded-lg bg-honors-image bg-cover bg-center bg-no-repeat px-8 py-12 backdrop-brightness-50 md:rounded-3xl md:px-24">
          ...
          <p className="mt-3 text-justify text-white">
            ...
            بهبود زیرساخت‌های شبکه، کلودگیمینگ و ... فعالیت می‌کرد. زمانی که به
            یک سری محصولات قابل استفاده و چند میلیون کاربر دست پیدا کرد، تصمیم
            گرفت به صورت کاملا رسمی و قانونی با هلدینگ بزرگ تابا تلکام که یکی از
            بزرگترین هلدنیگ‌های زیرساخت &nbsp;
            {!showMore && (
          ...
          <p className="read-more  text-justify	">
            ارتباط کشور است، همکاری می‌کند. حاصل این همکاری، پیاده‌سازی تمام
            پروژه‌های توسعه زیرساخت اینترنت در کشور و آوردن عصر جدید تکنولوژی به
            ایران است. در نتیجه امکان استفاده بدون محدودیت و امن از سرویس های
            بین المللی در شبکه محلی کشور، برای کاربران فراهم می‌شود. شرکت رایکا،
            طیف گسترده‌ای از خدمات را در حوزه توسعه زیرساخت های اینترنتی ارائه
            می‌کند. این محصولات و خدمات شامل موارد زیر می‌شوند: کلود کامپیوتینگ،
            ریموت گیمینگ-کلودگیمینگ، پروژه های تحت شبکه مانند سرویس‌های کاهش
            پینگ، سرویس‌های CDN، بهبود زیرساخت های شبکه، طراحی فایروال کاملا
            بومی، دسترسی به فریمورهای سرورها، ساخت سیستم عامل تلفن همراه بر پایه
            کرنل لینوکس و اندروید، ساخت و ویرایش سیستم عامل ویندوز برای
            کامپیوترها، اینکیریپشن و دیکیریپشن (رمزنگاری و رمزشکنی)، راه‌اندازی
            سرویس‌های ابری مثل سرویس های کلود و ساخت و ویرایش نرم افزارهای بومی
            بر روی سخت افزارهای مدرن مثل کارت های گرافیک، بومی‌سازی یک سری از
            تجهیزات سرور. ماموریت مجموعه این است که به مردم کشورمان کمک کنیم تا
            ...
            حوزه عملکرد کامپیوتر، فناوری اطلاعات و اینترنت، دسترسی راحتتر و
            بازدهی چند ده برابر بیشتر و البته با قیمتی پایین‌تر نسبت به
            فناوری‌های موجود در کشور به کاربران ارائه دهیم. در حال حاضر شرکت
            رایکا نزدیک به 17 پروژه ملی و فراملی در حوزه ارتباطی‌ دارد که شامل
            تمام مواردی است که با اینترنت و IT سروکار دارند. چشم‌انداز رایکا این
            است که در چند سال آینده به یکی از بزرگترین هلدینگ‌هایی که در مباحث
            اینترنتی کشور سرشناس است، مبدل شود.
            {showMore && (
              <label htmlFor="read-more-check-1" className="read-more-label">
                کم ...{" "}
              </label>

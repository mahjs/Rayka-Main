    ...
    <main className="flex flex-col gap-36 ">
      ...
      <article className=" mx-auto w-[90%] flex-col items-center justify-center rounded-lg bg-main-image bg-auto  bg-no-repeat px-8  py-12 md:rounded-3xl md:px-36 ">
        ...
        <p className="read-more text-justify	">
          ...
          موارد زیر می‌شوند: کلود کامپیوتینگ، ریموت گیمینگ-کلودگیمینگ، پروژه های
          تحت شبکه مانند سرویس‌های کاهش پینگ، سرویس‌های CDN، بهبود زیرساخت های
          شبکه، طراحی فایروال کاملا بومی، دسترسی به فریمورهای سرورها، ساخت سیستم
          عامل تلفن همراه بر پایه کرنل لینوکس و اندروید، ساخت و ویرایش سیستم
          عامل ویندوز برای کامپیوترها، اینکیریپشن و دیکیریپشن (رمزنگاری و
          رمزشکنی)، راه‌اندازی سرویس‌های ابری مثل سرویس های کلود و ساخت و ویرایش
          نرم افزارهای بومی بر روی سخت افزارهای مدرن مثل کارت های گرافیک،
          بومی‌سازی یک سری از تجهیزات سرور. ماموریت مجموعه این است که به مردم
          کشورمان کمک کنیم تا به راحتی به اینترنت دسترسی داشته باشند علی الخصوص
          در دنیای امروز که اینترنت بخشی جدایی ناپذیر از زندگی‌ها است. ما
          مفتخریم که تیمی متشکل از 50-30 نفر از متخصصان مجرب و متعهد در اختیار
          داریم تا بتوانیم در حوزه عملکرد کامپیوتر، فناوری اطلاعات و اینترنت،
          دسترسی راحتتر و بازدهی چند ده برابر بیشتر و البته با قیمتی پایین‌تر
          نسبت به فناوری‌های موجود در کشور به کاربران ارائه دهیم. در حال حاضر
          شرکت رایکا نزدیک به 17 پروژه ملی و فراملی در حوزه ارتباطی‌ دارد که
          شامل تمام مواردی است که با اینترنت و IT سروکار دارند. چشم‌انداز رایکا
          این است که در چند سال آینده به یکی از بزرگترین هلدینگ‌هایی که در مباحث

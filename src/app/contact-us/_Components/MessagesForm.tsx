  ...
  return (
    <Link href={link.href} passHref target="_blank" rel="noopener noreferrer">
      <div className={classNames}>
        {React.cloneElement(link.src, {
          className: "fill-current hover:fill-primary duration-300",
        })}
      </div>
    </Link>
  );
  ...
  return (
    <div className="mt-10 grid select-none place-items-center p-[1em] md:p-[2.5em] lg:grid-cols-2 lg:p-[5em]">
      <div className="h-full w-full">
        ...
        <div className="title-3 mr-1 mt-3 hidden text-semiBlack md:flex">
        ...
        <div className="mt-[3em] hidden items-center lg:flex ">
          <p className="subtitle-3 ml-3 text-semiBlack">

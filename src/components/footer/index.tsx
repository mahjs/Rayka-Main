  ...
  return (
    <div className="bg-black">
      <div
        ...
        className="relative z-0 mr-auto flex w-full justify-between gap-3 bg-footer-image object-contain px-3 pb-[2rem] pt-[6rem] md:items-center md:justify-around md:pb-[5rem] md:pt-[8rem]"
      >

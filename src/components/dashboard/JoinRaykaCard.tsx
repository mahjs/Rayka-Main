...
const JoinRaykaCard = () => {
  ...
  return (
    <div className="relative mr-auto flex w-[70%] items-center gap-5 rounded-3xl bg-[#FEA918] px-10 py-10 ">
      ...
      <div className="max-w-[50%] flex-col text-black">
        <p className="text-[1rem] font-[500]">
          تیم رایکا همواره در حال تلاش برای پیدا کردن استعداد های این سرزمین و
          بکارگیری آنها بصورت حضوری و دورکاری میباشد! حتما به صفحه فرصت های شغلی
          سر بزنید تا از فرصت های شغلی شرکت مطلع شوید!
        </p>
        <button
          onClick={() => {
            router.push("/career");
          }}
          className="mt-10 flex items-center justify-start gap-3 rounded-xl bg-black px-5 py-1"
        >
          <p className="text-right text-[#FEA918]"> مشاهده فرصت‌های شغلی</p>

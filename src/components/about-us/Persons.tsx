...
const Persons: React.FC<Props> = ({}) => {
  ...
  useEffect(() => {
    const updateImagesPerPage = () => {
      const newImagesPerPage = window.innerWidth < 800 ? 2 : 3;
  ...
  return (
    <div className="mb-[6.69rem] flex flex-col items-center justify-center">
      ...
      <div className="flex items-center justify-center gap-28">
        ...
        >
          <div
            className={`h-86 relative flex  w-[300rem] max-w-sm justify-center gap-4 overflow-hidden rounded-lg transition-all duration-300 md:h-[40rem] md:max-w-2xl md:gap-20 ${

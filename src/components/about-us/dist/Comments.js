...
var Comments = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: "relative mb-[14.35rem] flex h-[500px] items-start justify-center " },
        ...
        react_1["default"].createElement("div", { className: "z-10 flex flex-col items-center justify-start gap-10" },
            ...
            react_1["default"].createElement("div", { id: "controls-carousel", className: "relative w-full", "data-carousel": "static" },
                react_1["default"].createElement("div", { className: "flex justify-center gap-8" },
                    react_1["default"].createElement("div", { className: "relative mt-4 flex w-[30%] flex-col gap-12" },
                        react_1["default"].createElement("div", { className: "rounded-2xl bg-primary p-[1.90rem] text-justify transition-opacity duration-300 " + (isTransitioning ? "opacity-0" : "opacity-100") },
                            react_1["default"].createElement("p", null, testimonials[currentImageIndex].text),
                            react_1["default"].createElement("div", { className: "absolute mt-6 h-0 w-0 border-l-[22px] border-r-[22px] border-t-[40px] border-l-transparent border-r-transparent border-t-primary" })),
                        react_1["default"].createElement("div", { className: "flex items-center justify-start gap-5" },
                            react_1["default"].createElement("div", { className: "h-20 w-20 rounded-full border-4 border-solid border-primary bg-black" },
                                react_1["default"].createElement("div", { className: "mx-auto mt-[0.25rem] h-16 w-16 overflow-hidden rounded-full bg-transparent" },
                                    react_1["default"].createElement(image_1["default"], { src: testimonials[currentImageIndex].imageSrc, alt: testimonials[currentImageIndex].name, className: "rounded-full object-cover" }))),
                            react_1["default"].createElement("div", { className: "flex flex-col gap-3" },
                                react_1["default"].createElement("p", { className: "text-3xl font-bold text-white" }, testimonials[currentImageIndex].name),
                                react_1["default"].createElement("p", { className: "text-xl font-medium text-[#8C8C8C]" }, testimonials[currentImageIndex].title))))),

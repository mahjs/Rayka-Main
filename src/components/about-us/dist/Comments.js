        ...
        react_1["default"].createElement("div", { className: "z-10 flex flex-col items-center justify-start gap-10" },
            ...
            react_1["default"].createElement("div", { id: "controls-carousel", className: "relative w-full", "data-carousel": "static" },
                react_1["default"].createElement("div", { className: "flex justify-center gap-8" },
                    react_1["default"].createElement("div", { className: "flex flex-row-reverse justify-center gap-8" }, testimonials.map(function (testimonial, index) { return (react_1["default"].createElement("div", { key: index, className: "relative mt-4 flex w-[30%] flex-col gap-12 \n                " + (index < currentImageIndex
